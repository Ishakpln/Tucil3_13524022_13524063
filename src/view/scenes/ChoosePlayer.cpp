...
void ChoosePlayer::draw()
{
    ...
    DrawText(playerTypes[selectedIndex].c_str(), static_cast<int>(centerX - MeasureText(playerTypes[selectedIndex].c_str(), 26) / 2.0f), static_cast<int>(centerY - 170.0f), 26, Theme::Text);
