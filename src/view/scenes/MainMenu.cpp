...
MainMenu::MainMenu(GameState& gs):
    ...
    cmapBtn((Rectangle){(GetScreenWidth() - BUTTON_WIDTH)/2.0f, GetScreenHeight()/3.0f + (BUTTON_HEIGHT + BUTTON_GAP)*2 , BUTTON_WIDTH, BUTTON_HEIGHT}, 96, "Create Board", BLACK, BLACK, TEXT_BTN_SIZE),
