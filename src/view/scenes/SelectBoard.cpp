...
{
    DrawText("SELECT BOARD", 40, 30, 36, Theme::Text);
    ...
    DrawRectangleLinesEx(previewBounds, 2.0f, Fade(Theme::Text, 0.3f));
    DrawText("Preview Board", static_cast<int>(previewBounds.x), static_cast<int>(previewBounds.y - 30), 22, Theme::Text);
    ...
    {
        DrawText(errorMessage.c_str(), static_cast<int>(previewBounds.x + 20), static_cast<int>(previewBounds.y + 20), 20, Theme::Error);
    }
}
